...
id_academie_user INT(11) NOT NULL,
...
id_academie_rechercher INT(11) NOT NULL,
ville_rechercher varchar(255) NOT NULL DEFAULT "non-importe",
ecole_rechercher varchar(255) NOT NULL DEFAULT "non-importe",
...
id_user INT(11) NOT NULL,
id_dommande_moi INT(11) NOT NULL,
id_dommande_toi INT(11) NOT NULL,
...
Foreign key (id_dommande_moi) references dommande (id_dommande),
Foreign key (id_dommande_toi) references dommande (id_dommande),
Foreign key (id_user) references user (id_user),
